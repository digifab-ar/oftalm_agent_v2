...
- **[reference/DISENO_AGENTE_INTERMEDIO.md](./reference/DISENO_AGENTE_INTERMEDIO.md)** - Diseño del agente intermedio (POC)
- **[reference/foroptero-orchestrator/README.md](./reference/foroptero-orchestrator/README.md)** - Servidor POC con orquestador LLM (agudeza)
...
- **[reference/foroptero-server/README.md](./reference/foroptero-server/README.md)** - Documentación del backend legado
